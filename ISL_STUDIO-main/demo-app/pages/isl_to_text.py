...
class SignLanguageApp:
    def __init__(self):
        ...
        # Simple temporal smoothing + gating
        self._prob_ema = None
        self._ema_alpha = 0.4
    ...
    def process_frame(self, frame, selected_language):
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, 
                ...
                # Predict probabilities and apply EMA smoothing
                ...
                self._top_history = self._top_history[-8:]

                predicted_char = None
                # Require both a confidence gate and short consensus window
                ...
                # Overlay only the smoothed+gated prediction; include confidence if available
                overlay_text = (

...
class LocalPhraseRecognizer:
    ...
    def extract_keypoints(self, results):
        """
        Return a 63-dim vector (21 hand landmarks × 3 coords) that matches
        the model's expected training features. Prefer right hand if present,
        else fall back to left hand; if neither, return zeros.
        """
